...
public class MonsterFocusing extends AbstractOrb
{
    public static final String ORB_ID = "hubris:MonsterFocusing";
    ...
    public MonsterFocusing(OrbUsingMonster owner)
    {
        this.owner = owner;
        ID = ORB_ID;
    ...
    {
        return new MonsterFocusing(owner);
    }
}
